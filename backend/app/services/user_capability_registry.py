...
USER_CAPABILITIES: tuple[UserCapabilitySpec, ...] = (
    ...
    _cap("maintenance.list", "/support", "查询我的维修工单", "GET", "/api/maintenance"),
    _cap("maintenance.stats", "/support", "查询我的维修工单统计", "GET", "/api/maintenance/stats"),
    _cap("maintenance.get", "/support", "查询维修工单详情", "GET", "/api/maintenance/{ticket_id}"),
    _cap("maintenance.create", "/support", "提交维修工单", "POST", "/api/maintenance", WRITE),
    _cap(
        "maintenance.close",
        "/support",
        "关闭或撤销自己的维修工单",
