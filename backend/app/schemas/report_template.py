...
class ReportTemplateIn(BaseModel):
    ...
    content: str = Field(min_length=1, max_length=262_144, description="Jinja2 模板字符串")
...
class ReportTemplateUpdate(BaseModel):
    ...
    content: Optional[str] = Field(default=None, min_length=1, max_length=262_144, description="Jinja2 模板字符串")
    description: Optional[str] = Field(default=None, max_length=255, description="模板描述")
