"""普通成员 Skill 工坊权限补种(与 agent_asset 对称, 修复成员面 Skill 能力 403)。

Revision ID: 045_skill_asset_user_grant
Revises: 044_pentest_domain
"""
...
revision: str = "045_skill_asset_user_grant"
down_revision: Union[str, None] = "044_pentest_domain"
...
# reviewer/admin 的 skill_asset 权限已由 015 迁移授予。045 只负责普通用户，
# 使 downgrade 不会误删历史授权。
