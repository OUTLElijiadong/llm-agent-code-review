...
> **2026-07-10 当前状态说明**：后端已扩展到 28 个 API 模块、30 个 Model 模块、28 个 Schema 模块、45 个 Service 模块、21 个 Agent 顶层模块和 18 个 Skill 模块。本文目录树是早期核心骨架示例，不是完整文件清单；新增能力以源码和最新对齐文档为准。
