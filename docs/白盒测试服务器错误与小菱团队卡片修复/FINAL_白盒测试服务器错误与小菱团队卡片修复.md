...
- 生产运行 SHA：`4b0237050a43269a53c608068b2b0a1bca661afb`（包含归档、团队卡片、会话恢复和 PHP worker 判定修复）。
...
2026-08-19T02:12:40Z 部署完成。后端、前端同 SHA，数据库备份并完成隔离恢复校验（84 张表、Alembic 036）；五个生产容器均 healthy，域名 HTTPS 根入口 200。PHP 沙箱镜像已重建、固定 digest 并重启 executor。
