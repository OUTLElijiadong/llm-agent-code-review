...
| DELETE | `/api/admin/beta-codes/{invite_id}` | delete_beta_code |
...
| GET | `/api/agent-teams` | list_teams |
| POST | `/api/agent-teams` | create_team |
| GET | `/api/agent-teams/{team_id}` | get_team |
| POST | `/api/agent-teams/{team_id}/archive` | archive_team |
| POST | `/api/agent-teams/{team_id}/cancel` | cancel_team |
...
| PUT | `/api/issues/{issue_id}/review-decision` | review_decision |
...
| POST | `/api/knowledge/embedding-config/reembed` | reembed_all |
...
| DELETE | `/api/pentest/engagements/{public_id}` | delete_engagement |
| GET | `/api/pentest/engagements/{public_id}` | get_engagement |
...
| POST | `/api/projects/remote-imports` | queue_remote_project_import |
| GET | `/api/projects/remote-imports/{task_id}` | get_remote_project_import |
| POST | `/api/projects/remote-imports/{task_id}/cancel` | cancel_remote_project_import |
...
| DELETE | `/api/projects/{project_id}/source-revisions/{revision_id}` | delete_source_revision |
...
| `policy_rule` | 13 |
| `project` | 8 |
| `project_import_task` | 23 |
| `project_member` | 6 |
| `project_source_archive` | 24 |
| `project_source_revision` | 11 |
| `report_template` | 9 |
...
| Code | 分类 | Skill 数 | 描述 |
| --- | --- | ---: | --- |
| `ai_prompt` | output | 3 | 修复提示生成器:把审查发现一键翻译成可粘贴给 AI 编程工具的修复指令 |
| `chat_assistant` | frontline | 2 | 小菱本尊:像聊天一样帮你发审查、查项目、读报告,还能派子Agent团队干活 |
| `code_file_manager` | manager | 3 | 代码管家:帮你查项目里有哪些文件、按名字找代码、看任意文件内容 |
| `code_reviewer` | reviewer | 4 | 白盒审计员:逐行读代码,找出注入、越权、密钥泄露、性能坑,并给出修复建议 |
| `dashboard` | analytics | 3 | 数据播报员:汇总平台安全态势、风险分布和评分趋势,一句话讲清现状 |
...
| `review_orchestrator` | orchestrator | 4 | 审查总指挥:发起正式代码审查、跟进进度、汇总问题清单 |
...
- `frontend/src/views/pentest/PentestDetail.vue`
- `frontend/src/views/pentest/PentestList.vue`
- `frontend/src/views/pentest/PentestStart.vue`
...
| `028` | `027` | `backend/alembic/versions/028_add_tool_call_project_id.py` |
| `029` | `028` | `backend/alembic/versions/029_add_project_source_revision.py` |
| `030` | `029` | `backend/alembic/versions/030_agent_mesh.py` |
| `031` | `030` | `backend/alembic/versions/031_agent_mesh_dispatch_lease.py` |
| `032` | `031` | `backend/alembic/versions/032_strategy_memory.py` |
| `033` | `032` | `backend/alembic/versions/033_agent_team.py` |
| `034` | `033` | `backend/alembic/versions/034_agent_draft_permissions.py` |
| `035` | `034` | `backend/alembic/versions/035_security_scan_user.py` |
| `036` | `035` | `backend/alembic/versions/036_performance_indexes.py` |
| `037` | `036` | `backend/alembic/versions/037_review_execution_token.py` |
| `038` | `037` | `backend/alembic/versions/038_sandbox_recovery_snapshot.py` |
| `039` | `038` | `backend/alembic/versions/039_sandbox_execution_snapshot.py` |
| `040` | `039` | `backend/alembic/versions/040_sandbox_worker_request_envelope.py` |
| `041_review_result_pipeline` | `040` | `backend/alembic/versions/041_review_result_pipeline.py` |
| `041a_remote_import_tasks` | `040` | `backend/alembic/versions/041a_remote_import_tasks.py` |
| `042_merge_review_import_heads` | `041_review_result_pipeline, 041a_remote_import_tasks` | `backend/alembic/versions/042_merge_review_result_and_remote_import_heads.py` |
| `043_remote_import_lifecycle` | `042_merge_review_import_heads` | `backend/alembic/versions/043_remote_import_lifecycle.py` |
| `044_pentest_domain` | `043_remote_import_lifecycle` | `backend/alembic/versions/044_pentest_domain.py` |
