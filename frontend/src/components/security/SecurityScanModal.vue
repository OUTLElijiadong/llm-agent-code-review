...
const scanMode = ref<'full' | 'triage'>('full')
const topN = ref(50)
        ...
        <template v-else-if="isProjectScan">
          <template v-if="source === 'project'">
            ...
            <el-radio-group v-model="scanMode" size="small">
              <el-radio-button value="full">整包全量</el-radio-button>
              <el-radio-button value="triage">风险优先</el-radio-button>
            </el-radio-group>
            <el-input-number
              v-if="scanMode === 'triage'"
              v-model="topN"
              :min="1"
              :max="200"
              size="small"
