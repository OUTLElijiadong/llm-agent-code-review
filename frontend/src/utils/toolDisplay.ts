...
const TOOL_META: Record<string, ToolMeta> = {
  ...
  // 多智能体编排(子 Agent 团队)
  create_agent_team: { label: '创建子Agent团队', running: '小菱正在组建子Agent团队…', group: 'capability' },
  ...
  retry_agent_team: { label: '重试失败任务', running: '小菱正在重试失败任务…', group: 'capability' },
  cancel_agent_team: { label: '取消团队', running: '小菱正在取消团队…', group: 'capability' },
